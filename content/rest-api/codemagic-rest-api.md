...
You can find your API token by navigating to **Teams > Personal Account settings > Integrations > Codemagic API**. In API calls, use it as the value for the `x-auth-token` header:
