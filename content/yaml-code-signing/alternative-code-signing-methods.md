...
{{<notebox>}}
**Note:** This guide covers an alternative approach to iOS code signing that manages certificates and provisioning profiles through CLI tools and build scripts, instead of Codemagic's Code Signing Identities UI. If you prefer using Code Signing Identities, see [Signing iOS apps](../signing-ios).
{{</notebox>}}
