...
| FCI_REPO_SLUG            | The slug of the repository that is currently being built in the form owner_name/repository_name                 |
...
| FCI_PULL_REQUEST         | `true`, if the current build is building a pull request, unset otherwise                                        |
