---
description: A list of tools available out-of-the-box on Codemagic Intel-based macOS build machines using Xcode version 14.2.
title: macOS Intel-based build machine specification (Xcode 14.2)
aliases:
