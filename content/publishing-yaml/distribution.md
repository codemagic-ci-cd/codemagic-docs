...
Make sure to [encrypt](https://docs.codemagic.io/building/encrypting/) your Firebase token. It is possible to add it under publishing in the encrypted form directly or encrypt `FIREBASE_TOKEN` as an environment variable and reference it under publishing.
