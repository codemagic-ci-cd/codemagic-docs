...
6. For Android, select whether you wish to publish the Android app bundle, Android APK artifact, or both. If the checkboxes are disabled, make sure that you are building the appropriate artifact under **App settings > build > Android build format**.
