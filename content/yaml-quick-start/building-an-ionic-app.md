...
* All generated artifacts can be published to external services, such as email, Slack, Google Play, App Store Connect and Firebase App Distribution. The list of available integrations and script examples can be found in under the Publishing section.
