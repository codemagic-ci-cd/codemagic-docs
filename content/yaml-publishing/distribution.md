...
If you are getting a 400 error related to the app being in draft status, either publishing to draft can be enabled by **submit_as_draft: true** or there is a need to promote draft build to the next level up of testing tracks. Play Console will show you how to do this. You'll need to go through the steps, fill out questionnaires, upload various screenshots, and then after approval, you can move to the Alpha testing track, and Codemagic will successfully publish.
