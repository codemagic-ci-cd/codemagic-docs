...
4. Enter the alias(es) (name(s) with hyphens) of the **tester groups** to whom you want to distribute your Android or iOS app. The field is case-sensitive. To enter multiple groups, separate them with a comma or a space, or press Enter after each value.
