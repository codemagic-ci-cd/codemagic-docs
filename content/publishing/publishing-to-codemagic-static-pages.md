...
4. Click **Save** 
5. Select *Enabled* under **Enable Codemagic Static Pages Publishing** at the top of the section to enable publishing.
6. Click **Save** to finish the setup. On saving, we'll check the availability of the subdomain name and inform you if the name is already taken.
