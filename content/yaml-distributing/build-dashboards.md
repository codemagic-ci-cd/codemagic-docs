...
aliases:
  ...
  - /yaml-publishing/build-dashboards
---
...
2. Click the **Share dashboard** button at the top right of the page.
3. Enter the **Dashboard name** and use the **application**, **workflow**, **build status**, **labels**,  **branch** and **tag** filters to configure a build dashboard.
4. Then click **Create dashboard** at the bottom of the right configuration sidebar to generate a public link. A generated link will appear, and you can copy the link to the clipboard. The generated link will be also saved to the **Build dashboards** section in team settings.
