...
The CLI authenticates with the CodePush server using an access key generated by Codemagic.

The access key is generated automatically when enabling the CodePush Pay-as-you-go subscription in the Codemagic app. If you're looking to sign up for a fixed-price CodePush subscription, request access [here](https://codemagic.io/contact-sales/).
