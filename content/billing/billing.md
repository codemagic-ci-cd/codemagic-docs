...
Note that you may only disable billing if there are no unpaid invoices. In case you have unpaid invoices, please verify or update your card information. Navigate to Billing history and find any invoice that is not in status paid. Open up the invoice and click **Pay invoice**.
