...
Users can start new builds using [Codemagic REST API](https://docs.codemagic.io/rest-api/applications/). All data is sent and received as JSON. The REST API supports an optional parameter for environment variables. 
