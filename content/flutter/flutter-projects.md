...
### Building iOS apps
To reduce build time of a sigined ipa artifact, enable Flutter ipa builds in **App settings > Build > Flutter version**. Note that it requires Flutter 1.24.0-6.0 and above from a channel other than stable.
