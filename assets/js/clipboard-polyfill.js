        ...
        function (module, exports, __webpack_require__) {
            ...
            function write(data) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        if (
                            void 0 !== (text = data.getData(TEXT_PLAIN)) &&
                            (function (str) {
                                debugLog('copyTextUsingDOM')
                                var tempElem = document.createElement('div')
                                tempElem.setAttribute('style', '-webkit-user-select: text !important')
                                var spanParent = tempElem
                                tempElem.attachShadow &&
                    ...
                    return __generator(this, function (_a) {
                        return navigator.clipboard && navigator.clipboard.writeText
                            ? (debugLog('Using `navigator.clipboard.writeText()`.'),
                              [2, navigator.clipboard.writeText(s)])
                            : [2, write(DTFromText(s))]
                    })
                })
            }
            function read() {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        if (navigator.clipboard && navigator.clipboard.readText)
                            return (
                                debugLog('Using `navigator.clipboard.readText()`.'), [2, navigator.clipboard.readText()]
                            )
                        if (seemToBeInIE())
                            return (
                                ...
                                [
                                    ...
                                    (function () {
                                        return __awaiter(this, void 0, void 0, function () {
                                            var text
                                            return __generator(this, function (_a) {
                                                if ('' === (text = window.clipboardData.getData('Text')))
            ...
            function useStar() {
                useStarShown ||
                    (showWarnings &&
                        warn(
                            'You are using the deprecated default object of `clipboard-polyfill`. Please switch to `import * as clipboard from "clipboard-polyfill"` and see https://github.com/lgarron/clipboard-polyfill/issues/101 for more info.',
                        ),
                    (useStarShown = !0))
            }
            var ClipboardPolyfillDefault = (function () {
                ...
                return (
                    (ClipboardPolyfillDefault.setDebugLog = function (f) {
                    ...
                    (ClipboardPolyfillDefault.DT = DT_1.DT),
                    ClipboardPolyfillDefault
                )
            })()
                        ...
                        debugLog('listener called'),
                            ...
                            data.forEach(function (value, key) {
                                e.clipboardData.setData(key, value),
                                    key === TEXT_PLAIN &&
                                        e.clipboardData.getData(key) != value &&
                                        (debugLog('setting text/plain failed'), (tracker.success = !1))
                            }),
                            e.preventDefault()
                ...
                !(function (global, factory) {
                    ...
                    function handleMaybeThenable(promise, maybeThenable, then$$1) {
                        ...
                        maybeThenable.constructor.resolve === resolve$1
                            ...
                            : then$$1 === TRY_CATCH_ERROR
                            ? (reject(promise, TRY_CATCH_ERROR.error), (TRY_CATCH_ERROR.error = null))
                            : void 0 === then$$1
                    ...
                    function invokeCallback(settled, promise, callback, detail) {
                        ...
                        if (hasCallback) {
                            if (
                                ((value = (function (callback, detail) {
                                    try {
                                        return callback(detail)
                                    } catch (e) {
                                        return (TRY_CATCH_ERROR.error = e), TRY_CATCH_ERROR
                                    }
                                })(callback, detail)) === TRY_CATCH_ERROR
                                    ? ((failed = !0), (error = value.error), (value.error = null))
                                    : (succeeded = !0),
                                promise === value)
                            )
                                return void reject(
